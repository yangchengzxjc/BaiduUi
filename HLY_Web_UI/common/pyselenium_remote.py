...
class Pyapp_Remote(webdriver.Remote):
    """
    封装selenium常用方法，方便调用
    """
    def __init__(self,  command_executor=None, desired_capabilities=None, browser_profile=None, proxy=None, keep_alive=False):
        """
        返回浏览器对象
        """
        firefox_capabilities = {
            "browserName": "chrome",
            "version": "58.0.3029.81",  # 注意版本号一定要写对
            "platform": "ANY",
