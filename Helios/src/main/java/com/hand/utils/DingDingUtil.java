...
public class DingDingUtil {
    ...
    //通过钉钉机器人发送消息到钉钉群中
    public static void sendVal(String url, String suitName,String environment,int testAll,int testsPass,int testsFail,int testsSkip,String pass,String at) throws Exception {
