...
public class TravelApplication {
     ...
     * @throws HttpStatusException
     */
    public JsonArray getItinerary(Employee employee, String applicationOID, String itineraryType) throws
            HttpStatusException {
     ...
     * @throws HttpStatusException
     */
    public JsonObject createExpenseApplication(Employee employee, String formName, FormComponent component, String
            budget) throws HttpStatusException {
        //获取表单详情
        JsonObject formDetail = reimbursementApi.getFormDetail(employee, applicationFormOID(employee, formName));
     ...
     * @throws HttpStatusException
     */
    public HashMap<String, String> getCostCenterCustom(Employee employee, String formName) throws
            HttpStatusException {
