...
public class SyncService {
    ...
    /**
     * todo-构造饿了么审批单同步 tmc request dto
     *
     * @param travelApplicationDetail
     * @param diningItinerarys
     * @return
     */
    public SyncElemePlanRequest setElemePlanDTO(JsonObject travelApplicationDetail, JsonObject diningItinerarys) {
        SyncElemePlanRequest syncElemePlanRequest = new SyncElemePlanRequest();
        syncElemePlanRequest.setBusinessCode(travelApplicationDetail.get("businessCode").getAsString());
        SyncElemePlanRequest.TravelDiningRequest travelDiningRequest = new SyncElemePlanRequest.TravelDiningRequest();
        travelDiningRequest.setCompanyOID(travelApplicationDetail.get("companyOID").getAsString());
//        travelDiningRequest.setIsAllEmploy(travelApplicationDetail.get("").getAsInt());
        List<SyncElemePlanRequest.TravelDiningRequest> travelDiningRequests = new ArrayList<>();
        travelDiningRequests.add(travelDiningRequest);
        syncElemePlanRequest.setTravelDiningRequestList(travelDiningRequests);
