    ...
    public Object[][] vendorSSO() {
        if (env.equals("prod")) {
            ...
            return new Object[][]{
                    ...
                    {"甄选酒店H5首页单点登录",ZHENXUAN_HOTEL.getSupplierOID(),"H5","https://zhenxuan.huilianyi.com/?"},
                    ...
                    {"携程机票WEB首页单点登录", CTRIP_AIR.getSupplierOID(), "web","URL=https://www.corporatetravel.ctrip.com/corpservice/authorize/login"},
                    {"携程酒店WEB首页单点登录", CTRIP_HOTEL.getSupplierOID(), "web","URL=https://www.corporatetravel.ctrip.com/corpservice/authorize/login"},
                    {"携程火车WEB首页单点登录", CTRIP_TRAIN.getSupplierOID(), "web","URL=https://www.corporatetravel.ctrip.com/corpservice/authorize/login"},
                    {"携程机票H5订单单点登录", CTRIP_AIR.getSupplierOID(), "H5","URL=https://ct.ctrip.com/m/SingleSignOn/H5SignInfo&CallBack"},
                    {"携程酒店H5订单单点登录", CTRIP_HOTEL.getSupplierOID(), "H5","URL=https://ct.ctrip.com/m/SingleSignOn/H5SignInfo&CallBack"},
                    {"携程火车H5订单单点登录", CTRIP_TRAIN.getSupplierOID(), "H5","URL=https://ct.ctrip.com/m/SingleSignOn/H5SignInfo&CallBack"},
